...
.method private final zza(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v3, v5}, Landroidx/core/app/i$d;->a(I)Landroidx/core/app/i$d;
    ...
    invoke-virtual {v1, v5, v6}, Landroidx/core/app/i$d;->a(J)Landroidx/core/app/i$d;

    move-result-object v1

    invoke-virtual {v1, v4}, Landroidx/core/app/i$d;->b(Z)Landroidx/core/app/i$d;
    ...
    invoke-virtual {p4, p3}, Landroidx/core/app/i$d;->a(Ljava/lang/CharSequence;)Landroidx/core/app/i$d;

    move-result-object p3

    invoke-virtual {p3, v0}, Landroidx/core/app/i$d;->b(Ljava/lang/CharSequence;)Landroidx/core/app/i$d;

    move-result-object p3

    invoke-virtual {p3, v4}, Landroidx/core/app/i$d;->c(Z)Landroidx/core/app/i$d;

    move-result-object p3

    new-instance p4, Landroidx/core/app/i$b;

    invoke-direct {p4}, Landroidx/core/app/i$b;-><init>()V

    invoke-virtual {p4, v0}, Landroidx/core/app/i$b;->a(Ljava/lang/CharSequence;)Landroidx/core/app/i$b;

    move-result-object p4

    invoke-virtual {p3, p4}, Landroidx/core/app/i$d;->a(Landroidx/core/app/i$f;)Landroidx/core/app/i$d;
    ...
    invoke-virtual {p3, p1}, Landroidx/core/app/i$d;->a(Ljava/lang/String;)Landroidx/core/app/i$d;
