...
.method final c(Landroid/os/Bundle;)Z
    ...
    invoke-static {v3, v9, v8, v10}, Lcom/google/firebase/iid/ab;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v9, v11, v8, v10}, Lcom/google/firebase/iid/ab;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-direct {v3, v8}, Landroidx/core/app/i$d;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v1}, Landroidx/core/app/i$d;->b(Z)Landroidx/core/app/i$d;

    move-result-object v3

    invoke-virtual {v3, v6}, Landroidx/core/app/i$d;->a(I)Landroidx/core/app/i$d;
    ...
    invoke-virtual {v3, v5}, Landroidx/core/app/i$d;->b(Ljava/lang/CharSequence;)Landroidx/core/app/i$d;

    new-instance v4, Landroidx/core/app/i$b;

    invoke-direct {v4}, Landroidx/core/app/i$b;-><init>()V

    invoke-virtual {v4, v5}, Landroidx/core/app/i$b;->a(Ljava/lang/CharSequence;)Landroidx/core/app/i$b;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroidx/core/app/i$d;->a(Landroidx/core/app/i$f;)Landroidx/core/app/i$d;
    ...
    invoke-virtual {v3, v4}, Landroidx/core/app/i$d;->b(I)Landroidx/core/app/i$d;

    :cond_13
    if-eqz v0, :cond_14

    invoke-virtual {v3, v0}, Landroidx/core/app/i$d;->a(Landroid/net/Uri;)Landroidx/core/app/i$d;

    :cond_14
    if-eqz v9, :cond_15

    invoke-virtual {v3, v9}, Landroidx/core/app/i$d;->a(Landroid/app/PendingIntent;)Landroidx/core/app/i$d;

    :cond_15
    if-eqz v10, :cond_16

    invoke-virtual {v3, v10}, Landroidx/core/app/i$d;->b(Landroid/app/PendingIntent;)Landroidx/core/app/i$d;
