...
public class l extends a {
  ...
  public boolean a(int paramInt1, byte[] paramArrayOfbyte, byte paramByte, int paramInt2) {
    ...
    a1.a("FotaStage_22_TwsProgramDiffFotaStorage", stringBuilder.toString());
    if (paramByte != 0)
      return false; 
    ...
    if (v || arrayOfByte.length == 4) {
      this.a.a("FotaStage_22_TwsProgramDiffFotaStorage", String.format("Current queue size: %d", new Object[] { Integer.valueOf(this.c.size()) }));
      if (v || paramByte == 1) {
        for (paramInt1 = 0; paramInt1 < paramByte; paramInt1++) {
          ...
          if (a2 != null) {
            if (a2.b())
              return false; 
            this.a.a("FotaStage_22_TwsProgramDiffFotaStorage", "cmd.setIsRespStatusSuccess()");
            a2.c();
            this.x++;
  ...
  public void b() {
    ...
    for (a.a a1 : linkedHashMap.values()) {
      if (!a1.e)
        continue; 
      int i = d.a(a1.a);
      int k = a1.b + i;
  ...
  public boolean f() {
    ...
    while (iterator.hasNext()) {
      ...
      if (!a1.b()) {
        ...
        a2.a("FotaStage_22_TwsProgramDiffFotaStorage", stringBuilder.toString());
        return false;
      } 
    } 
    this.a.a("FotaStage_22_TwsProgramDiffFotaStorage", "all resp collected");
    return true;
  }
}


/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/airoha/android/lib/fota/stage/b/l.class
