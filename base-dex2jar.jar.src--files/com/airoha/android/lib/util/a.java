...
public class a implements Checksum {
  ...
  private final short[] b = new short[] { 
  ...
  private final short[] c = new short[] { 
  ...
  public void update(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    while (paramInt2 > 0) {
      this.d = (short)(this.d & 0xFF);
      short s = (short)(paramArrayOfbyte[paramInt1] & 0xFF);
      this.d = this.b[s ^ this.d];
      paramInt1++;
      paramInt2--;
    } 
    short[] arrayOfShort = this.c;
    paramInt1 = this.d;
    paramInt2 = arrayOfShort[paramInt1 & 0xF];
    this.d = (short)(byte)(arrayOfShort[paramInt1 >> 4] | paramInt2 << 4);
  }
}


/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/airoha/android/lib/util/a.class
