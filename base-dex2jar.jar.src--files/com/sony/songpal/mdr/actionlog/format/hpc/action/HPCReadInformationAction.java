...
public class HPCReadInformationAction extends HPCAction<HPCReadInformationAction> {
  ...
  public HPCReadInformationAction(f paramf) {
    super(h, paramf);
  }
  ...
  public HPCReadInformationAction d(String paramString) {
    a(Key.informationId, paramString);
    return this;
  }
  
  public HPCReadInformationAction e(String paramString) {
...
/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/sony/songpal/mdr/actionlog/format/hpc/action/HPCReadInformationAction.class
