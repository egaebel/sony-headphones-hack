...
public class HPCCloseInformationAction extends HPCAction<HPCCloseInformationAction> {
  ...
  public HPCCloseInformationAction(f paramf) {
    super(h, paramf);
  }
  ...
  public HPCCloseInformationAction d(String paramString) {
    a(Key.informationId, paramString);
    return this;
  }
  
  public HPCCloseInformationAction e(String paramString) {
...
/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/sony/songpal/mdr/actionlog/format/hpc/action/HPCCloseInformationAction.class
