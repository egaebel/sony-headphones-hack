...
public final class h {
  ...
  public h(int paramInt1, int paramInt2, List<u> paramList, boolean paramBoolean) {
    if (paramInt1 >= 0 && paramInt1 <= 255) {
      if (paramInt2 >= 0 && paramInt2 <= 255) {
        this.a = paramInt1;
        this.b = paramInt2;
        this.c = Collections.unmodifiableList(new ArrayList<u>(paramList));
        this.d = paramBoolean;
        return;
      } 
  ...
  public int a(EqPresetId paramEqPresetId) {
    ...
    for (int i = 0; iterator.hasNext(); i++) {
      if (((u)iterator.next()).a().equals(paramEqPresetId))
        return i; 
    } 
    return -1;
  }
  ...
  public EqPresetId a(int paramInt) {
    return ((u)this.c.get(paramInt)).a();
  }
  ...
  public u b(EqPresetId paramEqPresetId) {
...
/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/sony/songpal/mdr/j2objc/devicecapability/tableset1/h.class
