...
public final class b {
  ...
  public b(boolean paramBoolean, EqPresetId paramEqPresetId, int[] paramArrayOfint, List<p> paramList) {
    this.a = paramBoolean;
  ...
  private static int a(List<p> paramList) {
    ...
    while (iterator.hasNext()) {
      ...
      int n = k;
      int m = j;
      if (p.a() == EqBandInformationType.SPECIFIC_INFORMATION) {
        n = k;
        m = j;
        if (p.c() == SpecificInformationType.CLEAR_BASS) {
          n = k + 1;
          m = i;
        } 
      } 
...
/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/sony/songpal/mdr/j2objc/tandem/features/l/a/b.class
