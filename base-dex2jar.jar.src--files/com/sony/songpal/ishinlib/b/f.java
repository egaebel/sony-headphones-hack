...
public class f {
  ...
  private final String b = "ISHIN-pj";
  ...
  public boolean a(String paramString1, String paramString2) {
    ...
    //   30: aload_3
    //   31: aload_0
    //   32: invokespecial e : ()Ljava/lang/String;
  ...
  public boolean b() {
    ...
    stringBuilder1.append("ISHIN-pj");
    String str = stringBuilder1.toString();
    StringBuilder stringBuilder2 = new StringBuilder();
    stringBuilder2.append(str);
    stringBuilder2.append("/Log");
    return (new File(stringBuilder2.toString())).exists();
  }
  ...
  public void d() {
    ...
    if (arrayOfFile != null) {
      ...
      for (int i = 0; i < j; i++) {
        ...
        if (file.isDirectory()) {
          String[] arrayOfString = (new File(file.getPath())).list();
    ...
    if (arrayList.size() > 0) {
      ...
      MediaScannerConnection.scanFile(this.e.getApplicationContext(), arrayOfString, null, null);
    } 
  }
...
/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/sony/songpal/ishinlib/b/f.class
