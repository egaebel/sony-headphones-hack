...
class n {
  ...
  static n a(byte[] paramArrayOfbyte) {
    n n1 = new n();
  ...
  public boolean b(byte[] paramArrayOfbyte) {
    ...
    SpLog.c(a, "XMLDocument parse error. ", (Throwable)xmlPullParserException);
    return false;
  }
}


/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/sony/songpal/automagic/n.class
