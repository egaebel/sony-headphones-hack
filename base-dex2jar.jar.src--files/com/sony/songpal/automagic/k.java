...
class k {
  ...
  k(InformationHeader paramInformationHeader, n paramn) {
          ...
          if (str != null && str.length() > 0 && str3.length() > 0) {
            if (str2.equals("OSVersion") || str2.equals("FirmwareVersion") || str2.equals("FW_VERSION")) {
              try {
                ...
                SpLog.c(a, "Version string compare logic error. ", illegalArgumentException);
                bool = false;
              } 
            } else {
            ...
            SpLog.c(str5, String.format(locale, "(%s) %s %s %s -> %s", new Object[] { str2, str, str4, str3, str1 }));
            continue;
          } 
        } 
        bool = false;
  ...
  private boolean c(String paramString1, String paramString2, String paramString3) {
    return (Pattern.matches("^[0-9.]+$", paramString1) && Pattern.matches("^[0-9.]+$", paramString2)) ? d(paramString1, paramString2, paramString3) : e(paramString1, paramString2, paramString3);
  }
  ...
  private boolean d(String paramString1, String paramString2, String paramString3) {
    ...
    while (true) {
      ...
      String[] arrayOfString1 = stringBuilder.split("\\.", 0);
      i = b;
      ...
      while (true) {
        if (j < i) {
          try {
            ...
            stringBuilder1.append("Version information that does not conform to the format was specified (rhs ");
        ...
        boolean bool1 = true;
        if (bool)
          return (arrayOfInt1[0] == arrayOfInt2[0] && arrayOfInt1[1] == arrayOfInt2[1] && arrayOfInt1[2] == arrayOfInt2[2] && arrayOfInt1[3] == arrayOfInt2[3]); 
        if (paramString3.equals("NotEqual")) {
          bool = bool1;
        ...
        if (!paramString3.equals("Exist") && !paramString3.equals("NotExist"))
          ...
          } else if (!paramString3.equals("StartWith") && !paramString3.equals("NotStartWith") && !paramString3.equals("EndWith") && !paramString3.equals("NotEndWith") && !paramString3.equals("Include")) {
  ...
  public b a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5) {
  ...
  public static class b {
    ...
    public k.a a(HashMap<?, ?> param1HashMap) {
      ...
      if (param1HashMap.get("Size") != null) {
        bool = Integer.valueOf((String)param1HashMap.get("Size")).intValue();
      } else {
        bool = false;
      } 
      return new k.a((String)param1HashMap.get("Version"), (String)param1HashMap.get("URI"), (String)param1HashMap.get("MAC"), (String)param1HashMap.get("ClientVersion"), bool);
    }
      ...
      if (!arrayList.isEmpty()) {
        ...
        if (str2 != null) {
          ...
          while (true) {
            ...
            if (iterator.hasNext()) {
              str1 = iterator.next();
              if (!(str1 instanceof HashMap))
                continue; 
              hashMap1 = (HashMap)str1;
        ...
        if (arrayOfByte != null)
          try {
            ...
            SpLog.b(a, unsupportedEncodingException.getMessage());
          }  
      } 
      return "";
    }
...
/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/sony/songpal/automagic/k.class
