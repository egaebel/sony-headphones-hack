...
public final class s extends g {
  ...
  public byte[] c() {
    if (this.c > 255)
      SpLog.d(b, "mNumberOfPlayer > NUMBER_OF_PLAYER_MAX_VALUE !!"); 
    return new byte[] { (byte)(0xFF & this.c) };
  }
}


/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/sony/songpal/ble/client/characteristic/s.class
