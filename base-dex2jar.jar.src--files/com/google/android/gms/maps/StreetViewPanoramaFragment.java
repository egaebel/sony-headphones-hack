...
public class StreetViewPanoramaFragment extends Fragment {
  ...
  public void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback paramOnStreetViewPanoramaReadyCallback) {
    ...
    this.zzjcb.getStreetViewPanoramaAsync(paramOnStreetViewPanoramaReadyCallback);
  }
  ...
  public void onAttach(Activity paramActivity) {
    ...
    zzb.zza(this.zzjcb, paramActivity);
  }
  
  public void onCreate(Bundle paramBundle) {
    super.onCreate(paramBundle);
    this.zzjcb.onCreate(paramBundle);
  }
  
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
    return this.zzjcb.onCreateView(paramLayoutInflater, paramViewGroup, paramBundle);
  }
  ...
  public void onInflate(Activity paramActivity, AttributeSet paramAttributeSet, Bundle paramBundle) {
    ...
    try {
      ...
      zzb.zza(this.zzjcb, paramActivity);
      Bundle bundle = new Bundle();
      this.zzjcb.onInflate(paramActivity, bundle, paramBundle);
      return;
    } finally {
  ...
  public void onSaveInstanceState(Bundle paramBundle) {
    ...
    this.zzjcb.onSaveInstanceState(paramBundle);
  }
  ...
  static final class zza implements StreetViewLifecycleDelegate {
    ...
    public final void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback param1OnStreetViewPanoramaReadyCallback) {
      try {
        this.zzjcc.getStreetViewPanoramaAsync((zzbp)new zzah(this, param1OnStreetViewPanoramaReadyCallback));
        return;
  ...
  static final class zzb extends com.google.android.gms.dynamic.zza<zza> {
    ...
    private zzo<StreetViewPanoramaFragment.zza> zzjbn;
    ...
    private final void zzaxs() {
      if (this.zzakg != null && this.zzjbn != null && zzarg() == null)
        try {
          ...
          this.zzjbn.zza((LifecycleDelegate)new StreetViewPanoramaFragment.zza(this.zzjbk, iStreetViewPanoramaFragmentDelegate));
          for (OnStreetViewPanoramaReadyCallback onStreetViewPanoramaReadyCallback : this.zzjce)
            ((StreetViewPanoramaFragment.zza)zzarg()).getStreetViewPanoramaAsync(onStreetViewPanoramaReadyCallback); 
          this.zzjce.clear();
          return;
        } catch (RemoteException remoteException) {
          throw new RuntimeRemoteException(remoteException);
    ...
    public final void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback param1OnStreetViewPanoramaReadyCallback) {
      if (zzarg() != null) {
        ((StreetViewPanoramaFragment.zza)zzarg()).getStreetViewPanoramaAsync(param1OnStreetViewPanoramaReadyCallback);
        return;
      } 
...
/* Location:              /home/egaebel/Programs/sony-headphones-hack/base-dex2jar.jar!/com/google/android/gms/maps/StreetViewPanoramaFragment.class
